...
export default function BudgetPills({ budget, ragTotal = 8, searchTotal = 5 }: BudgetPillsProps) {
  const ragColor = pillColor(budget.rag_queries_remaining, ragTotal);
  const searchColor = pillColor(budget.external_search_queries_remaining, searchTotal);
