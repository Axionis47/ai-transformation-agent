...
const cls =
  "bg-surface border border-border text-text-primary p-1 text-sm font-mono rounded-sm focus:border-accent focus:outline-none w-48";

export default function AssumptionsReview({
  assumptions,
  onConfirm,
  loading,
}: AssumptionsReviewProps) {
    ...
    <div className="space-y-2">
      {items.map((assumption, idx) => (
        <div
          ...
          className="flex justify-between items-center border-b border-border py-1.5"
        >
          <div>
            <span
