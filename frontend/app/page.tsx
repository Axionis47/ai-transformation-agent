          ...
          <div className="max-w-6xl mx-auto p-6 lg:p-8">
            <div className="mb-8">
              ...
              <p className="text-sm text-ink-secondary">
                Enter a company to begin multi-agent AI opportunity research.
              </p>
            </div>
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    {defaults && (
                      <>
                        <ConfigRow
                          label="Search Budget"
                          value={`${defaults.search_budget} queries`}
                        />
                      ...
                      <div className="space-y-1.5">
                        {stages.map((stage, i) => (
                          <div key={stage} className="flex items-center gap-2.5">
                            <span className="text-2xs text-ink-tertiary font-mono w-4 text-right">
                              {i + 1}
                            </span>
...
function StatusRow({
  ...
  label: string;
  status: "online" | "ready" | "offline" | "loading" | "checking";
}) {
  const color =
